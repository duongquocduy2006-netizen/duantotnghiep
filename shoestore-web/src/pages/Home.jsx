...
const Home = () => {
    ...
    useEffect(() => {
        ...
        const update = () => {
            const start = new Date(flashSaleData.campaign.startDate).getTime();
            const end = new Date(flashSaleData.campaign.endDate).getTime();
            const now = Date.now();
                    ...
                    <div className="god-carousel-overlay d-flex align-items-center"
                                        ...
                                        <div className="container position-relative z-3">
                                            ...
                                            <div className={`god-carousel-caption ${
                                                i % 2 === 1 ? 'ms-auto animate__animated animate__fadeInRight'
